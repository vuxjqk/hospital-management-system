            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold">Danh sách thuốc</h3>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            <div class="bg-blue-100 p-3 rounded-lg" aria-label="Biểu tượng tổng thuốc">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-600">Tổng thuốc</p>
                                <p class="text-2xl font-bold text-gray-900">{{ $medicines->total() ?? 0 }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center">
                            <div class="bg-green-100 p-3 rounded-lg" aria-label="Biểu tượng thuốc đang hoạt động">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    {{ $medicines->where('is_active', 1)->count() ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center">
                            <div class="bg-amber-100 p-3 rounded-lg" aria-label="Biểu tượng thuốc tạm ngưng">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    {{ $medicines->where('is_active', 0)->count() ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 border-b border-gray-200 p-6">
                    <form method="GET" action="{{ route('medicines.index') }}" class="flex items-center space-x-4">
                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                {{ number_format($medicine->price, 0, ',', '.') }} VNĐ
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                        ...
                        <div class="text-center py-12">
                            <div class="max-w-md mx-auto">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    @if (request('search'))
                                        Không có thuốc nào phù hợp với từ khóa "{{ request('search') }}"
                                    @else
