<x-app-layout>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Cập nhật thông tin thuốc một cách chi tiết
                    </p>
                </div>
            </div>
    ...
    <div class="py-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('medicines.update', $medicine->id) }}" class="space-y-8">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name" required
                                    ...
                                    value="{{ old('name', $medicine->name) }}" placeholder="Nhập tên thuốc">
                                @error('name')
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="price" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-50 focus:bg-white"
                                    value="{{ old('price', $medicine->price) }}" placeholder="Nhập giá thuốc">
                                @error('price')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="unit" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-50 focus:bg-white"
                                    value="{{ old('unit', $medicine->unit) }}" placeholder="Nhập đơn vị">
                                @error('unit')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
