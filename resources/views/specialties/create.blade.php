<x-app-layout>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Tạo và quản lý thông tin chuyên khoa một cách chi tiết
                    </p>
                </div>
            </div>
    ...
    <div class="py-8 bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('specialties.store') }}" class="space-y-8">
                @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name" required
                                    ...
                                    value="{{ old('name') }}" placeholder="Nhập tên chuyên khoa">
                                @error('name')
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="fee" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 bg-gray-50 focus:bg-white"
                                    value="{{ old('fee') }}" placeholder="Nhập phí khám">
                                @error('fee')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
