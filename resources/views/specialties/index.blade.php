            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold">Danh sách chuyên khoa</h3>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            <div class="bg-blue-100 p-3 rounded-lg" aria-label="Biểu tượng tổng chuyên khoa">
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center">
                            <div class="bg-green-100 p-3 rounded-lg" aria-label="Biểu tượng chuyên khoa đang hoạt động">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    {{ $specialties->where('is_active', 1)->count() ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center">
                            <div class="bg-amber-100 p-3 rounded-lg" aria-label="Biểu tượng chuyên khoa tạm ngưng">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    {{ $specialties->where('is_active', 0)->count() ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 border-b border-gray-200 p-6">
                    <form method="GET" action="{{ route('specialties.index') }}" class="flex items-center space-x-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div class="flex justify-center space-x-2">
                                                ...
                                                <form action="{{ route('specialties.destroy', $specialty->id) }}"
                                                    ...
                                                    onsubmit="return confirm('Bạn có chắc chắn muốn xóa chuyên khoa này không?')">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                        ...
                        <div class="text-center py-12">
                            <div class="max-w-md mx-auto">
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    @if (request('search'))
                                        Không có chuyên khoa nào phù hợp với từ khóa "{{ request('search') }}"
                                    @else
                                        Hãy thêm chuyên khoa đầu tiên vào hệ thống
                                    @endif
                                </p>
                                <div class="mt-6">
                                    @if (request('search'))
                    ...
                    <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 flex justify-between sm:hidden">
                                ...
                                @else
                                    <a href="{{ $specialties->previousPageUrl() }}"
                                ...
                                @if ($specialties->hasMorePages())
                                    <a href="{{ $specialties->nextPageUrl() }}"
                            ...
                            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <p class="text-sm text-gray-700">
                                        Hiển thị
                                        <span class="font-medium">{{ $specialties->firstItem() }}</span>
                                        đến
                                        <span class="font-medium">{{ $specialties->lastItem() }}</span>
                                        trong
                                        <span class="font-medium">{{ $specialties->total() }}</span>
                                        kết quả
                                    </p>
                                </div>
                                <div>
